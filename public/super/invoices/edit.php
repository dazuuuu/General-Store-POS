...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($res['ok']) {
        ...
        header('Location: ' . public_url('super/invoices/edit.php?id=' . $id));
        exit;
    }
...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
  <div>
    ...
    <p class="text-muted small mb-0">Change customer details, quantities, prices, or products. Stock is adjusted when you save.</p>
  </div>
  <div class="d-flex gap-2 flex-wrap">
    <a class="btn btn-sm btn-outline-secondary" href="<?php echo public_url('super/invoices/'); ?>">Back</a>
    <a class="btn btn-sm btn-outline-primary" href="<?php echo public_url('super/orders/receipt.php?id=' . $id); ?>">Print</a>
  </div>
</div>
