...
if(empty($supportRouteMode)){header('Location: '.public_url('domain/support/businesses.php'));exit;}
...
<?php if(!$ready):?><div class="alert alert-warning"><strong>Support controls need their database migration.</strong> Run migrations before editing account access. <a href="<?php echo public_url('domain/support/migrations.php');?>">Open migration manager</a>.</div><?php endif;?>
