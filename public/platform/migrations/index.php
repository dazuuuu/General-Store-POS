...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  try{$name=(string)($_POST['migration']??'');$r=$runner->run($name,(int)TenantContext::userId());$result=$name.': '.$r['ran'].' statements executed, '.$r['skipped'].' already-existing statements skipped.';}
